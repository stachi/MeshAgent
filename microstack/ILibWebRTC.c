...
void* ILibStunClient_Start(void *Chain, unsigned short LocalPort, ILibStunClient_OnResult OnResult)
{
	...
	ILibChain_Link_SetMetadata(obj->UDP, ILibMemory_SmartAllocate_FromString("ILibWebRTC_stun_listener_ipv4"));
#ifdef WIN32
	...
	ILibChain_Link_SetMetadata(obj->UDP6, ILibMemory_SmartAllocate_FromString("ILibWebRTC_stun_listener_ipv6"));
#endif
